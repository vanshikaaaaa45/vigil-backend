...
// ── Maintenance windows ──────────────────────────────────────────
router.get   ('/monitors/:id/maintenance',            requireAuth, maintenance.list);
router.post  ('/monitors/:id/maintenance',            requireAuth, maintenance.create);
router.delete('/monitors/:id/maintenance/:windowId',  requireAuth, maintenance.remove);
